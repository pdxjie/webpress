...
public class Generator {
    ...
    public static void main(String[] args){
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/webpress?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8");
...
//        mpg.setTemplate(templateConfig);
        ...
        strategy.setInclude("web_dictionary");
        strategy.setNaming(NamingStrategy.underline_to_camel);//数据库表映射到实体的命名策略
        strategy.setTablePrefix("web_");//设置表前缀不生成
